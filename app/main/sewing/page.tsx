    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 space-y-6">
        ...
        <div className="pt-4 border-t border-gray-200">
            ...
            {/* Row 5: S5 to S8 */}
            <div className="grid grid-cols-4 gap-4 mt-4">
                {Object.keys(dataEntries).slice(16, 20).map(key => (
                    <div key={key} className="space-y-1">
                        <label htmlFor={key} className="block text-xs font-medium text-gray-500">{key}:</label>
                        <input
                            id={key}
            ...
            {/* Row 6: S9 to S12 */}
            <div className="grid grid-cols-4 gap-4 mt-4">
                {Object.keys(dataEntries).slice(20, 24).map(key => (
                    <div key={key} className="space-y-1">
                        <label htmlFor={key} className="block text-xs font-medium text-gray-500">{key}:</label>
                        <input
                            id={key}
            ...
            {/* Row 7: S13 to S16 */}
            <div className="grid grid-cols-4 gap-4 mt-4">
                {Object.keys(dataEntries).slice(24, 28).map(key => (
                    <div key={key} className="space-y-1">
                        <label htmlFor={key} className="block text-xs font-medium text-gray-500">{key}:</label>
                        <input
                            id={key}
            ...
            {/* Row 8: S17 to S20 */}
            <div className="grid grid-cols-4 gap-4 mt-4">
                {Object.keys(dataEntries).slice(28, 32).map(key => (
                    <div key={key} className="space-y-1">
                        <label htmlFor={key} className="block text-xs font-medium text-gray-500">{key}:</label>
                        <input
                            id={key}
            ...
            {/* Row 9: S21 to S24 */}
            <div className="grid grid-cols-4 gap-4 mt-4">
                {Object.keys(dataEntries).slice(32, 36).map(key => (
                    <div key={key} className="space-y-1">
                        <label htmlFor={key} className="block text-xs font-medium text-gray-500">{key}:</label>
                        <input
                            id={key}
            ...
            {/* Row 10: ST1 to ST2 */}
            <div className="grid grid-cols-4 gap-4 mt-4">
                {Object.keys(dataEntries).slice(36, 38).map(key => (
                    <div key={key} className="space-y-1">
                        <label htmlFor={key} className="block text-xs font-medium text-gray-500">{key}:</label>
                        <input
                            id={key}
